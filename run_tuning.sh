...
CONFIG_FILE="${SCRIPT_DIR}/configs/test_10pct.yaml"
OUTPUT_DIR="${SCRIPT_DIR}/outputs/optuna_tuning"
PYTHON_BIN="/home/duongtt/conda_env/DINO-MHC/bin/python"

# Tuning parameters
N_TRIALS=100              # Number of hyperparameter combinations to try
N_FOLDS=5                # Number of cross-validation folds
MAX_EPOCHS=10            # Max epochs per fold (keep low for fast tuning)
